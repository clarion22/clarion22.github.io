...
import myImg from '../../Assets/undraw_dev.svg';
import '../../style.css';
			...
			<Container>
				<Row>
					<Col md={8} className='home-about-description'>
						...
						<p className='home-about-body'>
							I am software engineer with a passion for creating
					...
					<Col md={12} className='home-about-social'>
						...
						<ul className='home-about-social-links'>
							<li className='social-icons'>
								<a
									href='https://github.com/clarion22'
									target='_blank'
									rel='noreferrer'
                ...
                >
                  <i className="fab fa-twitter"></i>
							...
							<li className='social-icons'>
								<a
									href='https://linkedin.com/in/olga-thompson-35937515a'
									target='_blank'
									rel='noreferrer'
									className='icon-colour  home-social-icons'
								>
